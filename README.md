...
Recent Computer Science graduate (University of Auckland) — I build things
end-to-end, from spatial backends to native desktop apps.

**Currently open to graduate / junior software engineering roles in NZ.**

**Tech I work with:** Python · C# · Swift · JavaScript · Flask · SwiftUI · PostgreSQL/PostGIS
...
- 💼 [LinkedIn](https://www.linkedin.com/in/dvhahn)
- 🐙 [GitHub](https://github.com/dvhahn)
